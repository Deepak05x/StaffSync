            ...
            <section className="xl:px-12 lg:px-8 sm:px-4 ssm:px-2 flex flex-col gap-12 py-8">
                ...
                <section className="flex items-center justify-between w-full p-4">
                    ...
                    <div className="w-[50%] flex items-center justify-center">
                        <img src="/img13.jpg" alt="" className="w-[30rem]" />
                    </div>
                </section>
                ...
                <div className="flex px-4 justify-between mb-[5rem]">
                    <button className="bg-light outline outline-dark text-2xl px-12 py-2 rounded-full">Cancel</button>
                    <button className="bg-dark text-light dark:text-dark dark:bg-light text-2xl px-12 py-2 rounded-full">Schedule Now</button>
                </div>
            </section>
            <Footer />
        </section>
